...
class QTILITIES_HEXEDIT_API HexEdit : public QAbstractScrollArea
{
    ...
    */
    ...
    /*! Set and get char to display when outside the printable range. */
...
signals:
    ...
    /*! Contains the beginning and end of selection. */
    void currentSelectionChanged(qint64 begin, qint64 end);
    ...
    /*! The signal is emitted every time, the read mode is changed. */
    void readModeChanged(bool state);
...
public:
    ...
    char defaultChar();
    void setDefaultChar(char defChar);
    ...
    void setSelection(qint64 begin, qint64 end);
